...
![/images/posts/TrelloCalendar/1.png](/images/posts/TrelloCalendar/1.png)

Power-Ups 這邊有三個進階的功能可供開啟，這邊我們只要開啟 Calendar 功能，因此點選 Calendar 就好。

![/images/posts/TrelloCalendar/2.png](/images/posts/TrelloCalendar/2.png)

這邊 Trello 會跟你介紹一下 Calendar 功能，直接按下 Enable 按鈕啟用即可。

![/images/posts/TrelloCalendar/3.png](/images/posts/TrelloCalendar/3.png)

注意到這邊，啟用下方的設定頁面可供我們決定是否啟用 iCalendar Feed，若想將 Trello 的卡標示在我們慣用的日曆像是 Google Calendar，這邊可以將之啟用，並將下方的 Feed 位置加入慣用的日曆。

![/images/posts/TrelloCalendar/4.png](/images/posts/TrelloCalendar/4.png)

Trello Calendar 啟用後，Trello 的右上方會多一個 Calendar 連結，點選可進入 Trello Calendar。

它有提供週日曆...

![/images/posts/TrelloCalendar/5.png](/images/posts/TrelloCalendar/5.png)

及月日曆兩種呈現方式，我們可依需求下去切換。

![/images/posts/TrelloCalendar/6.png](/images/posts/TrelloCalendar/6.png)
...
![/images/posts/TrelloCalendar/7.png](/images/posts/TrelloCalendar/7.png)

將 Feed 位置填入即可。

![/images/posts/TrelloCalendar/8.png](/images/posts/TrelloCalendar/8.png)
