...
slug: "csharp-vbnet-自定義-dotnet-windowform表單介面"
...
![image_thumb.png](/images/posts/5959/image_thumb.png)

Step2.設定其表單的FormBorderStyle屬性值為None，你會發現設完後其表單的標題列與視窗本來的邊框都不見了。

![image_thumb_19.png](/images/posts/5959/image_thumb_19.png)
...
![image_thumb_16.png](/images/posts/5959/image_thumb_16.png)

Step4.為了後面方便做到自定表單標題列的拖曳動作。我們在表單中加入一個Panel控制項，並使其Dock在最上面，且剛好覆蓋標題列。

![image_thumb_12.png](/images/posts/5959/image_thumb_12.png)

Step5.將剛放入的Panel的BackColor設為Transparent，設定完後Panel將會變成透明的，使用者無法用肉眼察覺此Panel的存在。

![image_thumb_18.png](/images/posts/5959/image_thumb_18.png)
...
![image_thumb_20.png](/images/posts/5959/image_thumb_20.png)
...
![image_thumb_22.png](/images/posts/5959/image_thumb_22.png)
