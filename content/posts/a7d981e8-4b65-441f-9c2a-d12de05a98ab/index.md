...
1. Quickly View all connection strings in a solution
2. Test one or all connection strings
3. Quick open
4. Add, Edit, Remove connection strings
5. Save connections for later
6. Swap connection strings
7. Add multiple connection strings to multiple configs at once
...
![image_thumb_16.png](/images/posts/a7d981e8-4b65-441f-9c2a-d12de05a98ab/image_thumb_16.png)

安裝完後，透過Tools\ConnectionString Manager將ConnectionString Manager開啟。

![image_thumb.png](/images/posts/a7d981e8-4b65-441f-9c2a-d12de05a98ab/image_thumb.png)
...
![image3_thumb.png](/images/posts/a7d981e8-4b65-441f-9c2a-d12de05a98ab/image3_thumb.png)

看到不該存在的連線字串，我們可以很快速的透過ConnectionString Manager將之刪除。

![image_thumb_11.png](/images/posts/a7d981e8-4b65-441f-9c2a-d12de05a98ab/image_thumb_11.png)

看到以後可以重用的連線字串，我們可以透過Add Connection To Saved按鈕將之儲存在ConnectionString Manager中，後續有需要時就可以直接拿來套用。

![image_thumb_12.png](/images/posts/a7d981e8-4b65-441f-9c2a-d12de05a98ab/image_thumb_12.png)

儲存的連線字串若有需要都可以透過Manage Saved Connections去管理。

![image_thumb_14.png](/images/posts/a7d981e8-4b65-441f-9c2a-d12de05a98ab/image_thumb_14.png)
...
![image9_thumb.png](/images/posts/a7d981e8-4b65-441f-9c2a-d12de05a98ab/image9_thumb.png)
...
![image_thumb_5.png](/images/posts/a7d981e8-4b65-441f-9c2a-d12de05a98ab/image_thumb_5.png)

開發人員可透過ConnectionString Editor對話框編輯連線字串的名稱與連線字串，也可以直接測試連線字串的連線狀況。

![image12_thumb.png](/images/posts/a7d981e8-4b65-441f-9c2a-d12de05a98ab/image12_thumb.png)

![image_thumb_6.png](/images/posts/a7d981e8-4b65-441f-9c2a-d12de05a98ab/image_thumb_6.png)
...
![image_thumb_9.png](/images/posts/a7d981e8-4b65-441f-9c2a-d12de05a98ab/image_thumb_9.png)

在New Connection編輯對話框中我們可以選取該連線字串要放置在哪個設定檔，以及新的連線字串內容。連線字串除了可以自行手動輸入外。

![image_thumb_8.png](/images/posts/a7d981e8-4b65-441f-9c2a-d12de05a98ab/image_thumb_8.png)

也可以直接套用先前儲存在ConnectionString Manager內的連線字串。

![image_thumb_15.png](/images/posts/a7d981e8-4b65-441f-9c2a-d12de05a98ab/image_thumb_15.png)
...
![image_thumb_10.png](/images/posts/a7d981e8-4b65-441f-9c2a-d12de05a98ab/image_thumb_10.png)

ConnectionString Manger算是一個不錯的擴充套件，針對連線字串的管理有其強大之處，若上述這些針對連線字串的操作已經困擾您許久，或是總是覺得不夠便利，那麼您可以下載這套擴充套件試試。

## Link

* [ConnectionString Manager](http://visualstudiogallery.msdn.microsoft.com/78c6d440-7a65-4ce3-af99-7e8f8e0676dc)
* [Introducing ConnectionString Manager](http://www.programmers-unlimited.com/)
