...
description: "Null propagation 是預計要在 C# 6.0 釋出的新功能，目前已可在 Visual Studio 14 中透過設定將功能開啟進行體驗，只要在方案檔中加上： Null propagation 能讓開發人員快速的在程式中做 Null 值的處理。"
...
![1.png](/images/posts/NullPropagation/1.png)
