...
```sql
private static string SerializeToText(T obj) {
...
private static T DeSerializeFromText(string text) {
...
```c#
public virtual void SerializeToFile(T obj, String file, Int32 bufferSize = 1024) {
...
public virtual T DeSerializeFromFile(String file, Int32 bufferSize) {
using (var fs = File.Open(file, FileMode.Open, FileAccess.Read, FileShare.ReadWrite)) {
using (var bs = new BufferedStream(fs, bufferSize)) {
return DeSerializeFromStream(bs);
}
}
}
```