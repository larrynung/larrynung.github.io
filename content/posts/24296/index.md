...
aliases: ["/posts/csharpvisual-studiodebug-with-object-id/"]
...
![image_thumb_7.png](/images/posts/24296/image_thumb_7.png)

![image_thumb_6.png](/images/posts/24296/image_thumb_6.png)

當我們為監看的物件加入Object ID後，監看畫面後方會出現該物件對應的Object ID。

![image_thumb_8.png](/images/posts/24296/image_thumb_8.png)

![image_thumb_15.png](/images/posts/24296/image_thumb_15.png)

Object ID加入後，可在監看視窗中加入Object ID去監看對應的物件。

![image_thumb_9.png](/images/posts/24296/image_thumb_9.png)

透過Object ID去監看對應的物件，就算物件已超出了作用範圍，只要尚未被垃圾回收器回收就能輕鬆的監看。

![image_thumb_10.png](/images/posts/24296/image_thumb_10.png)

除了監看視窗外，Object ID在即時運算視窗中也能夠使用。

![image_thumb_12.png](/images/posts/24296/image_thumb_12.png)

也能將之用於設定中斷點中斷的條件。

![image_thumb_13.png](/images/posts/24296/image_thumb_13.png)

若有取消Object ID的需求，可在監看視窗中找到已經設有Object ID的監看項目，在其上方按下滑鼠右鍵，接著點選右鍵選單中的Delete Object ID選單選項，就可以將其配置的Object ID給移除。

![image_thumb_14.png](/images/posts/24296/image_thumb_14.png)
