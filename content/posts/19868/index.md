...
description: "Linq to Excel為一Open Source函式庫，該函式庫能讓我們使用Linq去對Excel與CSV做查詢的動作。 使用前需先將LinqToExcel.dll與Remotion.Data.Linq.dll這兩個組件檔給加入參考，"
tags: [Linq, CSharp]
---
...
![image_thumb_9.png](/images/posts/19868/image_thumb_9.png)
...
![image_thumb_6.png](/images/posts/19868/image_thumb_6.png)

使用GetColumnNames方法取得的值會像下面這樣，只要Column打的是數值，取出來都會走樣。

![image_thumb_8.png](/images/posts/19868/image_thumb_8.png)

同樣的資料在Excel 2007下，跑起來就正常許多，但在空行的部份仍是跟我預期的不同。

![image_thumb_7.png](/images/posts/19868/image_thumb_7.png)
...
另外一提，Linq to Excel在使用上會自動去找尋第一個符合的資料，就算內容不是從Excel最左上的A1欄位開始，[Linq to Excel都會幫我們自動找尋，多半我們可以不指定要抓取的範圍，除非工作表內的資料是分成好幾塊。](http://code.google.com/p/linqtoexcel/)
...
![image_thumb.png](/images/posts/19868/image_thumb.png)

![image_thumb_4.png](/images/posts/19868/image_thumb_4.png)
...
![image_thumb_5.png](/images/posts/19868/image_thumb_5.png)
