---
title: "[C#][Control]Concept and Simple Implementation of a DIP Switch Control"
slug: "csharp-control-concept-and-simple-implementation-of-a-dip-switch-control"
aliases: ["/posts/csharpcontrol指撥開關控制項的概念與簡易實作/"]
date: "2011-12-10 10:21:35"
description: "筆者在前一家公司時是做自動儀器控制的，有些地方會要用類似像指撥開關這樣的設計給使用者跟真實世界一致的體驗，當初筆者有將這部分獨立出來做成可重用的元件，對其背後的實現概念有些許的體會，這邊簡單的摘錄其概念與簡單的實作範例。"
tags: [CSharp,Control]
---
