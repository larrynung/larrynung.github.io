...
![/images/posts/DiagnosticTools/1.png](/images/posts/DiagnosticTools/1.png)

一邊運行，一邊就會將 CPU、記憶體、與 Event 的狀態帶出。有效能問題開發人員可以即早發現。像這邊的記憶體曲線看起來雖然是平的，但是可以看到有很多次的 GC 出現，這就是需要進行調整的。

![/images/posts/DiagnosticTools/2.png](/images/posts/DiagnosticTools/2.png)
...
![/images/posts/DiagnosticTools/3.png](/images/posts/DiagnosticTools/3.png)
