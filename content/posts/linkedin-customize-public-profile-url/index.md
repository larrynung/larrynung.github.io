...
![1.png](/images/posts/CustomizeLinkedInProfileUrl/1.png)

開啟的 Public Profile 頁面會像下面這樣。

![2.png](/images/posts/CustomizeLinkedInProfileUrl/2.png)

將之向下捲動，在右側這邊會看到 Yor public profile URL 這個區塊，找到後點擊 Public Profile Url 後面的鉛筆圖示進行編輯。

![3.png](/images/posts/CustomizeLinkedInProfileUrl/3.png)

將之改為我們期望的網址後按下 Save 按鈕即可。

![4.png](/images/posts/CustomizeLinkedInProfileUrl/4.png)
