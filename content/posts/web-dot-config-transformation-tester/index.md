...
![1.png](/images/posts/ConfigTransformationTester/1.png)

轉換的設定檔內容放入 Transform (eg. Web.Debug.config) 區塊。

![2.png](/images/posts/ConfigTransformationTester/2.png)

接著按下 Transform 按鈕，轉換後的結果即會出現在 Result 區塊。

![3.png](/images/posts/ConfigTransformationTester/3.png)
