...
![1.png](/images/posts/HeapAllocationViewer/1.png)

搜尋框輸入 heapview 關鍵字，下載並安裝 Heap Allocation Viewer 套件 (若搜尋不到，可能是因為 ReSharper 太舊，需更新為 8.1 以後的版本)。

![2.png](/images/posts/HeapAllocationViewer/2.png)

![3.png](/images/posts/HeapAllocationViewer/3.png)

![4.png](/images/posts/HeapAllocationViewer/4.png)

安裝好後，Visual Studio 即會將 Heap 相關的操作 Highlight。

![5.png](/images/posts/HeapAllocationViewer/5.png)

![6.png](/images/posts/HeapAllocationViewer/6.png)
...
![7.png](/images/posts/HeapAllocationViewer/7.png)