...
使用上只要先選取.NET Framework的版本。

![image_thumb_3.png](/images/posts/13919/image_thumb_3.png)

按下[Verify Now]按鈕。

![image_thumb_2.png](/images/posts/13919/image_thumb_2.png)

程式會開始做驗證的動作。

![image_thumb_1.png](/images/posts/13919/image_thumb_1.png)

驗證完後，可在Current status看到驗證的結果。

![image_thumb.png](/images/posts/13919/image_thumb.png)

另外一提，經過測試，這套工具的防呆部分感覺有點沒做好，產品版本可以手動輸入，輸入後按下[Verify Now]會有不正確的結果。

![image_thumb_5.png](/images/posts/13919/image_thumb_5.png)

更多詳細的內容，請自行參閱該軟件壓縮檔內的ReadMe.Txt。
