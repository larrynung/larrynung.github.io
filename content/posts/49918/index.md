---
title: "[Visual Studio]Speed Up Visual Studio Builds with MSBuild Parallel Builds"
slug: "visual-studio-speed-up-visual-studio-builds-with-msbuild-parallel-builds"
aliases: ["/posts/49918/"]
...
![image_thumb.png](/images/posts/49918/image_thumb.png)
...
<table border="1" cellpadding="2" cellspacing="0" width="640"><tbody> <tr> <td valign="top" width="213"> </td> <td valign="top" width="213">Debug</td> <td valign="top" width="213">Release</td> </tr> <tr> <td valign="top" width="213">Arguments</td> <td valign="top" width="213">/m $(SolutionFileName) /v:m /property:Configuration=Release</td> <td valign="top" width="213">/m $(SolutionFileName) /v:m</td> </tr> <tr> <td valign="top" width="213">Initial directory</td> <td valign="top" width="213">$(SolutionDir)</td> <td valign="top" width="213">$(SolutionDir)</td> </tr> </tbody></table>

![image_thumb_2.png](/images/posts/49918/image_thumb_2.png)

設定好後，若有需要可以透過剛剛加入的外部工具選單選像去執行平行建置，也可以把它加到工具列按鈕使用。

![image_thumb_3.png](/images/posts/49918/image_thumb_3.png)

## Link

* [Hack: Parallel MSBuilds from within the Visual Studio IDE](http://www.hanselman.com/blog/HackParallelMSBuildsFromWithinTheVisualStudioIDE.aspx)
