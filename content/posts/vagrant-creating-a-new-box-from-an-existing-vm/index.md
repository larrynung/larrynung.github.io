...
![/images/posts/CreateVagrantBoxFromExistingVM/1.png](/images/posts/CreateVagrantBoxFromExistingVM/1.png)

輸入完我們就會看到指定的 box 產出。

我們可以將 box 加入。

![/images/posts/CreateVagrantBoxFromExistingVM/2.png](/images/posts/CreateVagrantBoxFromExistingVM/2.png)

後續直接透過 box 建立對應的環境。

![/images/posts/CreateVagrantBoxFromExistingVM/3.png](/images/posts/CreateVagrantBoxFromExistingVM/3.png)
