...
而若要使用.NET Framework內建的ColorTranslator類別來做轉換，可參閱MSDN文件中ColorTranslator.FromWin32 方法與[ColorTranslator.ToWin32 方法，直接帶入所需的參數呼叫函式即可。像是下面這樣：](http://msdn.microsoft.com/zh-tw/library/system.drawing.colortranslator.towin32(v=VS.80).aspx)
