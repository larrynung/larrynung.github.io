...
![image_thumb.png](/images/posts/36863/image_thumb.png)

此外Visual Studio 2011 Preview也提供了File Preview功能，該功能能認方案總管最後附著的編輯區，因此每個螢幕的編輯區附著上方案總管後，皆能夠有各自的File Preview，相當的好用。

![image_thumb_1.png](/images/posts/36863/image_thumb_1.png)

若是要將視窗還原，可以在視窗上面按下Ctrl按鍵，並用滑鼠連點。這個功能能將視窗還原到上次的位置，若本來視窗是從主視窗拉出，能夠過此動作將整個視窗快速的放回主視窗本來的位置。
