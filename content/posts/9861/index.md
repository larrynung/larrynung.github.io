...
## Link
C# 4.0（VB 10）與CLR 4.0之驚鴻一瞥C# 4.0 新特性：動態型別、選用參數、具名參數New Features in C# 4.0C# 4.0 Dynamic Lookup - Are You Kidding Me?C# 4.0's New Features ExplainedC# 4.0 新功能：動態繫結Dynamic Lookup & dynamic Type, C# 4.0 Part 1