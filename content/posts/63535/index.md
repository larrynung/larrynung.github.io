...
Visual Leak Detector for Visual C++ 2008/2010是一免費的開放源碼工具，能輔助開發人員偵測C++程式中記憶體洩漏的問題，使用上也算十分簡單，至[Visual Leak Detector for Visual C++ 2008/2010下載主程式後。](http://vld.codeplex.com/)

![image_thumb_4.png](/images/posts/63535/image_thumb_4.png)

安裝後會在Program Files(x86)下找到安裝的程式，裡面比較重要的就是bin、lib跟include幾個目錄，bin目錄存放dll組件，lib存放靜態函式庫，include則是存放著標頭擋。

![image_thumb.png](/images/posts/63535/image_thumb.png)

這邊以靜態函式庫為例，先開啟專案的屬性，在Additional Dependencies這邊設定lib檔的位置。

![image_thumb_1.png](/images/posts/63535/image_thumb_1.png)

Additional Include Directories這邊設定include目錄位置。

![image_thumb_2.png](/images/posts/63535/image_thumb_2.png)
...
![image_thumb_3.png](/images/posts/63535/image_thumb_3.png)
