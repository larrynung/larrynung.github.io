---
title: "[C#]Convert an Absolute Path to a Relative Path"
slug: "csharp-convert-an-absolute-path-to-a-relative-path"
aliases: ["/posts/csharp絕對路徑轉相對路徑/"]
date: "2011-03-17 01:05:51"
description: "之前在做壓縮的函式庫時，有碰到一個需求是壓縮整個目錄的資料，目錄裡面可能又含有許多子目錄，要壓縮時會需要指派其在壓縮檔內的存放位置，故會需要將要壓縮的檔案位置轉換為相對路徑，壓縮檔內依其相對位置做存放。"
tags: [CSharp]
---
