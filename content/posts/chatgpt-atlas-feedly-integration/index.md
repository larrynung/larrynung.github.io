...
![alt text](images/feedly-tech-trends.png)

### 客製化技術摘要 Feed
您可以高度客製化技術摘要 Feed，選擇感興趣的主題和更新頻率。設定完成後，ChatGPT 將定期為您推送包含技術焦點、文章摘要和應用建議的個人化報告。

![alt text](images/feedly-tech-articles-create-feed.png)
![alt text](images/feedly-customize-tech-summary-feed.png)
![alt text](images/feedly-confirm-tech-summary-feed-settings.png)
![alt text](images/feedly-first-tech-summary-feed.png)
![alt text](images/feedly-next-summary-push-features.png)

為方便管理，這些摘要還可匯出為 Markdown 格式的週報，輕鬆整合至 Notion 或其他筆記系統。
![alt text](images/feedly-markdown-export-option.png)
![alt text](images/feedly-markdown-export-confirmed-demo.png)

### 熱門主題深度分析
當您對 Feedly 中的熱門主題感興趣時，ChatGPT 能協助識別相關網頁，並提供摘要與應用建議。它能自動截取全文進行深入分析，或讓您手動貼上內容，提供文章背景、技術細節、關鍵概念和應用場景等全面解析。
![alt text](images/feedly-popular-topics-summary-request.png)
![alt text](images/feedly-full-text-analysis-options.png)
例如，針對 SpringCloud Gateway 的文章，它能提供詳細的主題背景與技術摘要。
![alt text](images/feedly-springcloud-gateway-summary.png)
