...
![/images/posts/GenerateClientFromRAML/1.png](/images/posts/GenerateClientFromRAML/1.png)

安裝完後要輔助開發 Client 端程式的話，我們只要透過方案總管在專案的 Reference 上按下滑鼠右鍵，選取 `Add RAML Reference...` 選單選項。

![/images/posts/GenerateClientFromRAML/2.png](/images/posts/GenerateClientFromRAML/2.png)

`Add RAML Reference` 視窗即會跳出，這邊可透過網址或是檔案的方式來指定 RAML 檔案。

![/images/posts/GenerateClientFromRAML/3.png](/images/posts/GenerateClientFromRAML/3.png)

這邊筆者用 Twitter 的 RAML 來做個示範，複製其 RAML 的網址。

![/images/posts/GenerateClientFromRAML/4.png](/images/posts/GenerateClientFromRAML/4.png)
...
![/images/posts/GenerateClientFromRAML/5.png](/images/posts/GenerateClientFromRAML/5.png)

接著 RAML Tools for .NET 會幫我們將 RAML 檔依剛帶的設定加入專案中，會放在 API References 的目錄之內，也會透過 NuGet 加入一些必要的套件。

![/images/posts/GenerateClientFromRAML/6.png](/images/posts/GenerateClientFromRAML/6.png)

RAML 檔下面也可以看到該擴充套件會幫我們產生好對應的強型別類型。

![/images/posts/GenerateClientFromRAML/7.png](/images/posts/GenerateClientFromRAML/7.png)

跟本來的 RAML 定義是一致的，開發 Client 端程式時直接叫用即可，不用在依 Spec 下去串 API。

![/images/posts/GenerateClientFromRAML/8.png](/images/posts/GenerateClientFromRAML/8.png)
