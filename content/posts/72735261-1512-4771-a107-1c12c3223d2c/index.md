---
title: "[C#]How to Detect Whether a File Is Locked"
slug: "csharp-how-to-detect-whether-a-file-is-locked"
aliases: ["/posts/csharp如何偵測特定檔案是否為lock狀態/"]
date: "2013-11-06 12:00:00"
description: "要怎樣才能有效的偵測出檔案是被Lock住，這樣的問題在程式開發時開發人員常常會碰到，筆者看到多半的解法都是試圖去開開看檔案，當檔案無法開啟時就視為檔案被Lock住。這樣的做法雖不算錯，但總是不太精確，因為很多情況都有可能造成開檔錯誤，不見得都能很單純的這樣做判斷。"
tags: [CSharp]
---
...
![image_thumb.png](/images/posts/72735261-1512-4771-a107-1c12c3223d2c/image_thumb.png)

而取出error code後之所以要判斷32與33這兩個值，則是因為它們分別是ERROR_SHARING_VIOLATION與ERROR_LOCK_VIOLATION這兩個錯誤碼，看一下MSDN的定義相信就不難理解。

![image_thumb_1.png](/images/posts/72735261-1512-4771-a107-1c12c3223d2c/image_thumb_1.png)
