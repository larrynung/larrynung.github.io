...
![1.png](/images/posts/PLSQLCopForSQLDeveloper/1.png)

![2.png](/images/posts/PLSQLCopForSQLDeveloper/2.png)
...
![3.png](/images/posts/PLSQLCopForSQLDeveloper/3.png)

設好後按下 Finish 按鈕進行安裝。

![4.png](/images/posts/PLSQLCopForSQLDeveloper/4.png)

重啟 SQL Developer。

![5.png](/images/posts/PLSQLCopForSQLDeveloper/5.png)

這時套件已經被安裝並複製至 SQL Developer 內。

![6.png](/images/posts/PLSQLCopForSQLDeveloper/6.png)

安裝完後要分析程式碼只要在程式碼上按下滑鼠右鍵，在彈出的滑鼠右鍵快顯選單中，選取 Check 選單選項。

![7.png](/images/posts/PLSQLCopForSQLDeveloper/7.png)

PL/SQL Cop for SQL Developer 會將違背規則的地方給列出。

![8.png](/images/posts/PLSQLCopForSQLDeveloper/8.png)

除了違背的規則列表外，PL/SQL Cop for SQL Developer 也提共了詳細的報表。

![9.png](/images/posts/PLSQLCopForSQLDeveloper/9.png)

按下 Open 按鈕用瀏覽器來看，我們可以看到上半部這邊會列出複雜度、可維護性之類的指標。

![10.png](/images/posts/PLSQLCopForSQLDeveloper/10.png)

下半部這邊會列出程式碼中違背的規則，以及違背的規則分布狀態。

![11.png](/images/posts/PLSQLCopForSQLDeveloper/11.png)
...
![12.png](/images/posts/PLSQLCopForSQLDeveloper/12.png)
