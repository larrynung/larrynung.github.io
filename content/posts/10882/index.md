---
title: "[C#]Check Current Power Status with the GetSystemPowerStatus API"
slug: "csharp-check-current-power-status-with-the-getsystempowerstatus-api"
aliases: ["/posts/csharp使用getsystempowerstatus-api查看目前電源使用狀態/"]
