...
![1.png](/images/posts/SpecFlowGettingStarted/1.png)

![2.png](/images/posts/SpecFlowGettingStarted/2.png)

![3.png](/images/posts/SpecFlowGettingStarted/3.png)

然後建立一個測試專案，並透過 NuGet 為其加入 SpecFlow Package。  

![4.png](/images/posts/SpecFlowGettingStarted/4.png)

![5.png](/images/posts/SpecFlowGettingStarted/5.png)

![6.png](/images/posts/SpecFlowGettingStarted/6.png)

套件加入後在專案中會多個 App.config 檔，若非使用 NUnut 去撰寫測試，這邊需加指定 unitTestProvider。  

![7.png](/images/posts/SpecFlowGettingStarted/7.png)

接著用 SpecFlow Extension 裝進去的 SpecFlow Feature File 範本建立一個 Feature 檔 。  

![8.png](/images/posts/SpecFlowGettingStarted/8.png)

Feature 檔建立後會長的像下面這樣：  

![9.png](/images/posts/SpecFlowGettingStarted/9.png)
...
![10.png](/images/posts/SpecFlowGettingStarted/10.png)

Scenario 撰寫完後，我們可以在 Feature 檔的上面按下滑鼠右鍵，在彈出的滑鼠右鍵快顯選單中選取 `Generate Step Definitions` 選單選項。  

![11.png](/images/posts/SpecFlowGettingStarted/11.png)
...
![12.png](/images/posts/SpecFlowGettingStarted/12.png)
...
![13.png](/images/posts/SpecFlowGettingStarted/13.png)
...
![14.png](/images/posts/SpecFlowGettingStarted/14.png)
...
![15.png](/images/posts/SpecFlowGettingStarted/15.png)

要產生的 Step 與要使用的 Style 選取完後，因為我們是尚未有對應的 Step 檔，所以要按下 Generate 按鈕建立對應的 Step 檔。    

![16.png](/images/posts/SpecFlowGettingStarted/16.png)

![17.png](/images/posts/SpecFlowGettingStarted/17.png)

Step 檔建立後會像下面這樣，預設 Step 的方法裡面放的都是 ScenarioContext.Current.Pending()，也就是待處理的意思。  

![18.png](/images/posts/SpecFlowGettingStarted/18.png)
...
![19.png](/images/posts/SpecFlowGettingStarted/19.png)

寫完後準備開始運行測試，需先確定 Test runner tool 設定正確，不然會無法正常運行測試。  

![20.png](/images/posts/SpecFlowGettingStarted/20.png)
...
![21.png](/images/posts/SpecFlowGettingStarted/21.png)

![22.png](/images/posts/SpecFlowGettingStarted/22.png)

![23.png](/images/posts/SpecFlowGettingStarted/23.png)
...
![24.png](/images/posts/SpecFlowGettingStarted/24.png)

因為對應的 Step 檔案已經建立，所以 `Generate Step Definition Skeleton` 視窗這邊要改選 `Copy methods to clipboard`。

![25.png](/images/posts/SpecFlowGettingStarted/25.png)

接著開啟對應的 Step 檔將剛複製的內容貼上，多出來的 Step 就進去了。注意到這邊，SpecFlow 已經將我們在 Scenario Step 中用數值描述的部分改用參數帶入，我們可以直接在後面實作中使用。

![26.png](/images/posts/SpecFlowGettingStarted/26.png)

![27.png](/images/posts/SpecFlowGettingStarted/27.png)
...
![28.png](/images/posts/SpecFlowGettingStarted/28.png)

建立的 Step 就會將資料表示用 Table 帶入。需注意到這邊的 Table 非我們常用的 ADO.NET 的 Table，但操作上大同小異。  

![29.png](/images/posts/SpecFlowGettingStarted/29.png)
...
![30.png](/images/posts/SpecFlowGettingStarted/30.png)

![31.png](/images/posts/SpecFlowGettingStarted/31.png)