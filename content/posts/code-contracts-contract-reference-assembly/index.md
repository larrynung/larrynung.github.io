...
![1.png](/images/posts/ContractReferenceAssembly/1.png)

這個功能在 .Net Framework 中就有被廣泛使用。可以看到 .Net Framework 這邊就有提供許多的 Contract Reference Assembly 。

![2.png](/images/posts/ContractReferenceAssembly/2.png)

反組譯可以看到裡面只有存放 Code Contracts 的部分。

![3.png](/images/posts/ContractReferenceAssembly/3.png)

使用對應的方法，也能看到 Code Contracts 功能是正常運作的。

![4.png](/images/posts/ContractReferenceAssembly/4.png)
