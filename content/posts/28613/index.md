...
![image3_thumb.png](/images/posts/28613/image3_thumb.png)

找到並下載In-App Advertising and Monetization (C#)這個元件。

![image6_thumb.png](/images/posts/28613/image6_thumb.png)

![image9_thumb.png](/images/posts/28613/image9_thumb.png)
...
![image_thumb_5.png](/images/posts/28613/image_thumb_5.png)

再按一下[OK]按鈕。

![image_thumb_8.png](/images/posts/28613/image_thumb_8.png)

AdViewControl控制項就會放置在工具箱中。

![image_thumb_4.png](/images/posts/28613/image_thumb_4.png)

將AdViewControl控制項拖曳放置應用程式，調整放置想要顯示廣告的位置。

![image_thumb_6.png](/images/posts/28613/image_thumb_6.png)

設定AdViewControl控制項的屬性，最重要的是要將申請的SiteID與ZoneID帶入屬性值中，其它還有很多有用的屬性可依自己需求下去設定，像是InternalBrowser可以設定瀏覽廣告時是以內建的瀏覽視窗來瀏覽。

![image_thumb_7.png](/images/posts/28613/image_thumb_7.png)
...
![image_thumb.png](/images/posts/28613/image_thumb.png)
