...
![image_thumb.png](/images/posts/48500118-6bcc-4a81-9b0c-0343a8371f38/image_thumb.png)

接著在方案上按下右鍵叫出滑鼠右鍵選單，點選Add Solution to Source Control這個選單選項。

![image_thumb_1.png](/images/posts/48500118-6bcc-4a81-9b0c-0343a8371f38/image_thumb_1.png)

點選後會彈出個對話框詢問要放置到Team Fundation Service的哪個專案，以及要放在哪個目錄下面。這邊請視個人需求下去設定，設定完後按下OK按鈕繼續。

![image_thumb_2.png](/images/posts/48500118-6bcc-4a81-9b0c-0343a8371f38/image_thumb_2.png)

透過Source Control Explorer我們可以看到選取的位置會多出我們所創建的專案。再仔細看的話可以發現前面會多帶一個"+"符號，代表這個是新增且未Check In的。

![image_thumb_3.png](/images/posts/48500118-6bcc-4a81-9b0c-0343a8371f38/image_thumb_3.png)
...
![image_thumb_4.png](/images/posts/48500118-6bcc-4a81-9b0c-0343a8371f38/image_thumb_4.png)

Visual Studio會再次確認是否要將這些變動Check In上去，若是確定這邊就直接按下Yes繼續。

![image_thumb_5.png](/images/posts/48500118-6bcc-4a81-9b0c-0343a8371f38/image_thumb_5.png)

Check In後Team Explorer會提示這次的動作是成功或是失敗。

![image_thumb_6.png](/images/posts/48500118-6bcc-4a81-9b0c-0343a8371f38/image_thumb_6.png)
...
![image_thumb_7.png](/images/posts/48500118-6bcc-4a81-9b0c-0343a8371f38/image_thumb_7.png)

另外我們也可以直接連至Team Fundation Service網頁，這邊看到的程式碼應該會是新的。

![image_thumb_8.png](/images/posts/48500118-6bcc-4a81-9b0c-0343a8371f38/image_thumb_8.png)

changesets頁籤這邊應該也會有新的Commit紀錄。

![image_thumb_9.png](/images/posts/48500118-6bcc-4a81-9b0c-0343a8371f38/image_thumb_9.png)
