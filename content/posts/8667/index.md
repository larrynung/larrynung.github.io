---
title: "[VB.NET]Increase Image Brightness"
slug: "vbnet-increase-image-brightness"
aliases: ["/posts/8667/"]
date: "2009-06-04 09:00:07"
description: "Introduction 本篇的主旨在於介紹如何增加圖片的亮度。主要的作法就是把圖片上的每個像素的RGB值都增加相同的數值，當數值加完後超過255將以255替換。 範例程式 VB.NET 執行結果："
tags: [VB.NET]
---
