...
description: "要對 T4 Template 進行偵錯，首先需將 Template 的 Debug 設定開啟。 接著在要除錯的位置上加入中斷點。 然後在 T4 Template 檔案上按下滑鼠右鍵，在彈出的滑鼠右鍵快顯選單中點選 'Debug T4 Template' 選單選項，即可開始進行偵錯。"
tags: [T4]
---

要對 T4 Template 進行偵錯，首先需將 Template 的 Debug 設定開啟。

![1.png](/images/posts/DebugT4Template/1.png)

接著在要除錯的位置上加入中斷點。

![2.png](/images/posts/DebugT4Template/2.png)

然後在 T4 Template 檔案上按下滑鼠右鍵，在彈出的滑鼠右鍵快顯選單中點選 'Debug T4 Template' 選單選項，即可開始進行偵錯。

![3.png](/images/posts/DebugT4Template/3.png)

![4.png](/images/posts/DebugT4Template/4.png)

![5.png](/images/posts/DebugT4Template/5.png)
