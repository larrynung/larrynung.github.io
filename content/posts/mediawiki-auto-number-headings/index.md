...
![1.png](/images/posts/MediaWikiAutoNumberHeadings/1.png)

找到 `$wgDefaultUserOptions['numberheadings']` 設定，將其值設定為 1。

$wgDefaultUserOptions['numberheadings'] = 1;

![2.png](/images/posts/MediaWikiAutoNumberHeadings/2.png)

這樣 MediaWiki 的標頭前面就會自動編號。

![3.png](/images/posts/MediaWikiAutoNumberHeadings/3.png)
