...
description: "前面介紹 PostSharp 時，筆者多半都是透過精靈介面將之套用至專案之中，在加 Log 時有一步驟是設定 Log 機制背後要用的服務，這個在精靈介面設定完後，若有修改的必要，我們可以參閱下表： 將本來使用到的 Log Profile 其對應的 NuGet Package 移除，"
tags: [PostSharp]
---

前面介紹 PostSharp 時，筆者多半都是透過精靈介面將之套用至專案之中，在加 Log 時有一步驟是設定 Log 機制背後要用的服務，這個在精靈介面設定完後，若有修改的必要，我們可以參閱下表：

![1.png](/images/posts/PostSharpChangLoggingBackEnd/1.png)
...
![2.png](/images/posts/PostSharpChangLoggingBackEnd/2.png)
