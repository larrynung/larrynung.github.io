---
title: "[C++]Detect Memory Overrun Errors with PageHeap"
slug: "cpp-detect-memory-overrun-errors-with-pageheap"
aliases: ["/posts/59767/"]
...
![image_thumb.png](/images/posts/59767/image_thumb.png)
...
![image_thumb_3.png](/images/posts/59767/image_thumb_3.png)

不然再使用Pageheap時會出現"Error: Cannot open image registry key for testpageheap1.exe"這樣的錯誤訊息。

![image_thumb_2.png](/images/posts/59767/image_thumb_2.png)

以系統管理員身分執行命令提示字元後，我們將目錄切至要偵測的程式所在目錄，使用Pageheap /enable [檔名]啟用越界錯誤的偵測，接著輸入Pageheap確認是否啟用越界錯誤偵測成功。

![image_thumb_4.png](/images/posts/59767/image_thumb_4.png)

啟用成功後再次執行我們的程式，可以發現越界錯誤發生了，這樣我們就可以立即的找到並修復這樣的問題。

![image_thumb_5.png](/images/posts/59767/image_thumb_5.png)

當調試完成，我們可以執行Pageheap /disable [檔名]將越界錯誤偵測給關閉。

![image_thumb_6.png](/images/posts/59767/image_thumb_6.png)
