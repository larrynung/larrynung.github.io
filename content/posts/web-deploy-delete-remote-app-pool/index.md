...
description: "如要使用 Web Deploy 刪除遠端 application pool，可以指定 Web Deploy 使用 delete 操作，dest 使用 appPoolConfig provider，並帶入要刪除的 application pool 名稱，"
tags: [Web Deploy]
---
...
msdeploy –verb:delete –dest: appPoolConfig ="",computerName=
