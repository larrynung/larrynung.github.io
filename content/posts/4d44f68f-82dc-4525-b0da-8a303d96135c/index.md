...
![image_thumb_1.png](/images/posts/4d44f68f-82dc-4525-b0da-8a303d96135c/image_thumb_1.png)

而Advanced Edit選項則是可以看到這個測試效能的工具是用怎樣的程式碼去計算效能的，進階的使用者也可以進一步調整。

![image_thumb_4.png](/images/posts/4d44f68f-82dc-4525-b0da-8a303d96135c/image_thumb_4.png)

若想要看程式對應的IL碼，可切換至ILDasm Result頁面，因為是借用SDK的ILDasm來做反組譯，所以第一次切換必須指定ILDasm檔案的位置。

![image_thumb.png](/images/posts/4d44f68f-82dc-4525-b0da-8a303d96135c/image_thumb.png)

設定完後可在該頁面看到對應的IL碼。

![image_thumb_2.png](/images/posts/4d44f68f-82dc-4525-b0da-8a303d96135c/image_thumb_2.png)

程式碼輸入完，若要開始進行效能測試，可將PerfCompare切換至Performance頁面，鍵入要測試的次數與可用來識別測試的字樣，按下Go按鈕，測試即會開始運行，測試完畢下方會顯示所花費的測試時間。

![image_thumb_3.png](/images/posts/4d44f68f-82dc-4525-b0da-8a303d96135c/image_thumb_3.png)

要做測試一定要會有要比較的對象，上面的示範是測試用String.Join去做字串的串連，因為我們要跟StringBuilder的串連下去做比較，因此必須再切回到Code頁面輸入StringBuilder做字串串連的程式碼。

![image_thumb_5.png](/images/posts/4d44f68f-82dc-4525-b0da-8a303d96135c/image_thumb_5.png)

在切到Performance頁面，修改用來識別測試的字樣，再次按下Go按鈕進行測試。

![image_thumb_6.png](/images/posts/4d44f68f-82dc-4525-b0da-8a303d96135c/image_thumb_6.png)
...
![image_thumb_7.png](/images/posts/4d44f68f-82dc-4525-b0da-8a303d96135c/image_thumb_7.png)

PerfCompare會幫我們算好速度上差異大概是幾倍。

![image_thumb_8.png](/images/posts/4d44f68f-82dc-4525-b0da-8a303d96135c/image_thumb_8.png)
...
![image_thumb_9.png](/images/posts/4d44f68f-82dc-4525-b0da-8a303d96135c/image_thumb_9.png)

運行後結果會被輸出至LogLine() Output頁面。

![image_thumb_10.png](/images/posts/4d44f68f-82dc-4525-b0da-8a303d96135c/image_thumb_10.png)
