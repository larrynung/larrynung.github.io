---
title: "[C#]More Effective C# Item 49: Consider Weak References for Large Objects"
slug: "csharp-more-effective-csharp-item-49-consider-weak-references-for-large-objects"
aliases: ["/posts/csharpmore-effective-c#-條款四十九-考慮為大型物件使用弱引用/"]
date: "2011-03-09 10:08:11"
description: "在.Net的世界中，物件的引用可被分為強引用與弱引用兩種。所謂的強引用指的就是我們一般在使用的物件引用方式。我們可將這種物件引用視為一個釘子，牢牢的釘在物件實體上面，只要物件實體仍有被強引用給參考，該物件實體就會被固定的死死的，不能被GC給回收，因這樣的引用特性是很強烈的，故稱之為強引用。"
tags: [CSharp]
---
