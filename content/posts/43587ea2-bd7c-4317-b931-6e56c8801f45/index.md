---
title: "[C#]How to Specify a Window ClassName to Receive Window Messages in a .NET App"
slug: "csharp-how-to-specify-a-window-classname-to-receive-window-messages-in-a-dotnet-app"
aliases: ["/posts/csharp在.net程式中要如何指定windows的classname去接收視窗的訊息/"]
