...
tags: [Visual Studio]
description: "要修改 Visual Studio 的 Target language version，我們可以開啟專案屬性，將之切換至 Build 頁面，接著點選右下角的 Advanced... 按鈕。 將 Language Version 下拉框下拉，選取我們欲使用的版本即可。"
---

要修改 Visual Studio 的 Target language version，我們可以開啟專案屬性，將之切換至 Build 頁面，接著點選右下角的 `Advanced...` 按鈕。

![1.png](/images/posts/ChangeLanguageVersion/1.png)

將 Language Version 下拉框下拉，選取我們欲使用的版本即可。

![2.png](/images/posts/ChangeLanguageVersion/2.png)
