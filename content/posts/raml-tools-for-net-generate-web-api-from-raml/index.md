...
![1.png](/images/posts/GenerateWebAPIFromRAML/1.png)

Add RAML Contract 視窗即會跳出，這邊可為該 Web API 創建個新的 RAML contract，或是透過網址及檔案的方式來指定已存在的 RAML 檔案。

![2.png](/images/posts/GenerateWebAPIFromRAML/2.png)
...
![3.png](/images/posts/GenerateWebAPIFromRAML/3.png)

接著 RAML Tools for .NET 會幫我們將 RAML 檔依剛帶的設定加入專案中，會將 RAML 設定放在 Contracts\inculdes 的目錄之內，同時會幫我們將需要的 Controller 產生好。

![4.png](/images/posts/GenerateWebAPIFromRAML/4.png)

接著只要將 Controller 內的動作完成即可。

![5.png](/images/posts/GenerateWebAPIFromRAML/5.png)
...
![6.png](/images/posts/GenerateWebAPIFromRAML/6.png)
