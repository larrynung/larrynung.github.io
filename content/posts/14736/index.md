---
title: "[VB.NET]Implement Spy++'s Drag-to-Target Finder"
slug: "vbnet-implement-spy-s-drag-to-target-finder"
aliases: ["/posts/14736/"]
date: "2010-04-22 12:32:19"
description: "相信有做過開發的大家，對於Spy++這套軟體一定都不陌生，應該也都知道在Spy++中有個可以拖曳的箭靶，透過這個可拖曳的箭靶，使用者可以很快速的指定要監看的視窗。今天這篇就是稍微紀錄一下如何實作這個拖曳箭靶。 實作的概念很簡單，只要準備兩張圖片、一張滑鼠游標。"
tags: [VB.NET]
---
