---
title: "[C#]How to Get the Recently Used Documents on Windows"
slug: "csharp-how-to-get-the-recently-used-documents-on-windows"
aliases: ["/posts/csharp如何取出最近在windows上所使用的文件檔案/"]
date: "2013-11-06 12:00:00"
description: "最近在評估一個功能，希望能用Windows最近使用的文件檔案做些對應的處理，這邊不想用監控整個檔案系統的方式，也不想要像防毒軟體一樣Hook，因此想到在Windows中有Recent Items這樣的東西，假設我能取得這邊的資訊，應該也就夠我做些處理了。"
tags: [CSharp]
---
...
![image_thumb_2.png](/images/posts/727c291b-2b61-4703-89d1-3029421f90d7/image_thumb_2.png)

稍微花點時間研究了一下，發現Recent Items的資料主要是由"%appdata%\Microsoft\Windows\Recent"這邊來的。

![image_thumb_3.png](/images/posts/727c291b-2b61-4703-89d1-3029421f90d7/image_thumb_3.png)
...
![image_thumb_4.png](/images/posts/727c291b-2b61-4703-89d1-3029421f90d7/image_thumb_4.png)

最後補充一下，若想要偵測的僅僅是用Office所存取的文件，不想要偵測那麼大範圍的話，我們可以改用"%appdata%\Microsoft\Office\Recent"位置去做一樣的處理動作，它們的存放方式是一樣的。

![image_thumb_5.png](/images/posts/727c291b-2b61-4703-89d1-3029421f90d7/image_thumb_5.png)
