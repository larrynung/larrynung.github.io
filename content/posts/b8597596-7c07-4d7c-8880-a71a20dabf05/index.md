...
private static Boolean HasDefaultConstructor1()
{
var type = typeof (T);
...
private static Boolean HasDefaultConstructor2()
{
var type = typeof (T);
...
{
Console.WriteLine(HasDefaultConstructor1());
Console.WriteLine(HasDefaultConstructor2());
