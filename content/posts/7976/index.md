...
**操作畫面 :**![community_class_en.png](/images/posts/7976/community_class_en.png)

## ArgoUML

**官方網站 :** [Link](http://argouml.tigris.org/)

**特色 :** ArgoUML is the leading open source UML modeling tool and includes support for all standard UML 1.4 diagrams. It runs on any Java platform and is available in ten languages. See the [feature list](http://argouml.tigris.org/features.html) for more details.

**操作畫面 :**![welcome_screenshot_0_26.png](/images/posts/7976/welcome_screenshot_0_26.png)

## StarUML

**官方網站 :** [Link](http://staruml.sourceforge.net/en/index.php)
...
* **UML 2.0** : UML is continuously expanding standard managed by [OMG(Object Management Group)](http://www.omg.org/). Recently, UML 2.0 is released and StarUML support UML 2.0 and will support lastest UML standard.
...
**官方網站 :**  [Link](http://bouml.sourceforge.net/)

**特色 :**

* it is free
* it runs under **Linux/Unix/Solaris**, **Mac OS X** and **Windows** thanks to [**Qt**](http://www.trolltech.com/)
...
* it is extensible, and the external tools (I name them [*plug-outs*](http://bouml.sourceforge.net/doc/index_plugout.html) because they are executed outside BOUML) may be developed in C++ or Java, using BOUML for their definition as any other program. Frankly I do not like very much language like *Visual Basic*, and I do not understand how this one can be imposed in a UML environment !
* it is very fast and doesn't require much memory to manage several thousands of classes, see [benchmark](http://bouml.sourceforge.net/benchmark.html)

**操作畫面 :**![all_medium.png](/images/posts/7976/all_medium.png)

## gModeler

**官方網站 :** [Link](http://www.gskinner.com/gmodeler/)

**使用網址 :** [Link](http://www.gskinner.com/gmodeler/app/run.html)
...
* Built in [FlashOS2](http://flashos.net/), for an attractive, intuitive interface.

**操作畫面 :**![image3_thumb.png](/images/posts/7976/image3_thumb.png)
