...
![image6_thumb.png](/images/posts/13417/image6_thumb.png)

也可以滑鼠游標直接移到類別成員上，按下滑鼠右鍵，在快顯選單中選取[View Call Hierarchy]選項。Visual Studio會帶出Call Hierarchy視窗，並把其類別成員加入其中。
![image_thumb.png](/images/posts/13417/image_thumb.png)

Call Hierarchy視窗顯示上會像下面這樣。

![image9_thumb.png](/images/posts/13417/image9_thumb.png)

上方的工具列具有過濾的功能，可選取所要監看的結果是整個方案、目前專案、或是目前文件。

![image15_thumb.png](/images/posts/13417/image15_thumb.png)

還可以切換是否要詳細到顯示程式碼的資訊。

![image18_thumb.png](/images/posts/13417/image18_thumb.png)
...
![image21_thumb.png](/images/posts/13417/image21_thumb.png)

可自行針對有興趣的部份去作展開。像這邊展開[Calls To 'Balance']，就可以發現到只有Main這邊有使用到Balance。

![image24_thumb.png](/images/posts/13417/image24_thumb.png)

若想移至程式碼部分，透過滑鼠左鍵點選兩下即可。

![image_thumb_1.png](/images/posts/13417/image_thumb_1.png)

也可以在右半邊的詳細列表中連點想觀看的程式碼部分，Visual Studio會自動幫您帶到程式碼中對應的地方。

![image_thumb_4.png](/images/posts/13417/image_thumb_4.png)

值得注意的是，Call Hierarchy視窗在顯示上是採用階層式的顯示方式，所以像下方的Main函式也可以再作展開，可以讓我們做一層層的監看。

![image27_thumb.png](/images/posts/13417/image27_thumb.png)

若覺得一層層看很難看，我們也可以透過滑鼠右鍵，再彈出的快顯選單中點選[Add As New Root]。

![image_thumb_10.png](/images/posts/13417/image_thumb_10.png)

就可以把有興趣的部分再提出成為根節點。

![image_thumb_12.png](/images/posts/13417/image_thumb_12.png)
