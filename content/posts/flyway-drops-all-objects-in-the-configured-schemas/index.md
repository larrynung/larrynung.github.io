...
description: "Flyway 的 Clean 功能能將資料庫內所有東西都清除，不論是 Table、View、還是 Procedure。 通常用在測試 Migration 時。 像是這邊有一個已經 Migration 過的資料庫。 Clean 以後... flyway clean 資料庫內的資料都會被清掉。"
tags: [Flyway]
---
