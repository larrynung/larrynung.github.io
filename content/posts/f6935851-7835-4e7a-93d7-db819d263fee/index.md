---
title: "[C++]Get the Local IP with the GetAdaptersAddresses API"
slug: "cpp-get-the-local-ip-with-the-getadaptersaddresses-api"
aliases: ["/posts/f6935851-7835-4e7a-93d7-db819d263fee/"]
...
取得了網卡資訊後，網卡資訊會是IP_ADAPTER_ADDRESSES structure的型態，以Linked List的方式存放，因此在取用時必須遍尋Linked List每個元素，取出我們需要的IP位置，其中比較麻煩的就是IP位置是以[SOCKET_ADDRESS structure型態存放，要透過inet_ntop function轉換為字串，程式寫起來就像下面這樣：](http://msdn.microsoft.com/en-us/library/windows/desktop/ms740507(v=vs.85).aspx)
...
![image_thumb.png](/images/posts/f6935851-7835-4e7a-93d7-db819d263fee/image_thumb.png)
