...
![image_thumb.png](/images/posts/21091/image_thumb.png)

若有找到的程式會在左半邊用樹狀節點顯示其組成架構，可以藉此知道界面是由哪些元件所組成，而在右側則是會顯示其選取物件的屬性。

![image_thumb_6.png](/images/posts/21091/image_thumb_6.png)

若是左側元件過多無法判別是否為想要觀察的元件，可以在左側樹節點上方點選滑鼠右件，點選[Show Window]滑鼠右鍵快顯選單。

![image_thumb_4.png](/images/posts/21091/image_thumb_4.png)

對應的元件就會出現短暫的藍色框框閃爍。

![image_thumb_1.png](/images/posts/21091/image_thumb_1.png)

若有需要，你可以在執行階段透過ManagedSpy動態改變元件的屬性，並觀察其變化。

![image_thumb_2.png](/images/posts/21091/image_thumb_2.png)

若要觀察應用程式的事件驅動是否正常，或是想了解會觸發的事件與事件觸發的順序，也可以透過上方工具列的第一個過濾按鈕設定所要觀察的事件。

![image_thumb_5.png](/images/posts/21091/image_thumb_5.png)

並按下上方工具列的執行按鈕，開始監控.NET應用程式的事件觸發。

![image_thumb_3.png](/images/posts/21091/image_thumb_3.png)

## Download

[ManagedSpy.exe](http://download.microsoft.com/download/f/2/7/f279e71e-efb0-4155-873d-5554a0608523/ManagedSpy.exe)

## Link

* [Deliver The Power Of Spy++ To Windows Forms With Our New Tool](http://msdn.microsoft.com/en-us/magazine/cc163617.aspx)
* [MANAGED SPY：用我們的新工具繼續Spy++對Windows Forms的神話](http://www.vckbase.com/document/viewdoc/?id=1625)
