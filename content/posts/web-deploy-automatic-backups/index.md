...
![1.png](/images/posts/WebDeployAutoBackup/1.png)
...
![2.png](/images/posts/WebDeployAutoBackup/2.png)
...
![3.png](/images/posts/WebDeployAutoBackup/3.png)

若是在備份時失敗，Web Deploy 的 Deploy 訊息也會告知。

![4.png](/images/posts/WebDeployAutoBackup/4.png)

備份的檔案會放置在我們所設定的備份位置，裡面也只是整個 Application 的壓縮以及一些還原用的設定。

![5.png](/images/posts/WebDeployAutoBackup/5.png)
