---
title: "[C#]How to Specify the Member Property for LINQ Distinct"
slug: "csharp-how-to-specify-the-member-property-for-linq-distinct"
aliases: ["/posts/csharplinq在使用distinct去除重複資料時如何指定所要依據的成員屬性/"]
date: "2013-11-06 12:00:00"
description: "最近專案中在用Linq Distinct想要將重複的資料去除時，發現它跟Any之類的方法有點不太一樣，不能很直覺的在呼叫時直接帶入重複資料判斷的處理邏輯，所以當我們要用某個成員屬性做重複資料的判斷時，就必需繞一下路，這邊稍微將處理的方法做個整理並記錄一下。"
tags: [CSharp]
---
...
![image_thumb.png](/images/posts/82d44d46-a0ac-450d-9600-a1dd40c407a9/image_thumb.png)
...
![image_thumb_1.png](/images/posts/82d44d46-a0ac-450d-9600-a1dd40c407a9/image_thumb_1.png)
