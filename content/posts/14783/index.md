...
![image_thumb.png](/images/posts/14783/image_thumb.png)

分別拖曳箭靶至三個密碼框，用以觸發把EM_SETPASSWORDCHAR屬性給取消的程式碼。

![image_thumb_1.png](/images/posts/14783/image_thumb_1.png)

實驗後發現，前兩個密碼框變回一般的文字輸入框，而最後一個密碼框仍舊完好。

![image_thumb_2.png](/images/posts/14783/image_thumb_2.png)
