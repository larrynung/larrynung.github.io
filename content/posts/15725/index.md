---
title: "[VC.NET]Fix VC.NET Forms That Won't Open in the Form Designer"
slug: "vc-dotnet-fix-vc-dotnet-forms-that-won-t-open-in-the-form-designer"
aliases: ["/posts/15725/"]
date: "2010-06-08 10:27:47"
description: "有用過VC.NET的可能都有發現，已經編輯好的表單有時會變成像一般的標頭檔一樣，怎樣都無法切換回表單設計畫面，最後只得用修改程式碼的方式來調整介面。 多半這種問題是因為從別的專案做加入檔案至專案的動作所導致，舉個例子來說，假設今天有個表單Form1。"
tags: [C++]
---
