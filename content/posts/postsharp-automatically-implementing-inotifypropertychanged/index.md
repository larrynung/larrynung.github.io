...
![/images/posts/PostSharpINotifyPropertyChangedImplement/1.png](/images/posts/PostSharpINotifyPropertyChangedImplement/1.png)

接著 PostSharp 擴充套件會帶出精靈視窗，第一頁是 Summary 頁面，這邊只是告訴我們繼續下去會做什麼事，不外乎就是加入套件引用與加上對應的 Attribute，這邊直接 Next。

![/images/posts/PostSharpINotifyPropertyChangedImplement/2.png](/images/posts/PostSharpINotifyPropertyChangedImplement/2.png)

如 Summary 頁面所提，要處理的東西有點多，進度要稍微跑一下。

![/images/posts/PostSharpINotifyPropertyChangedImplement/3.png](/images/posts/PostSharpINotifyPropertyChangedImplement/3.png)

進度跑完後按下 Finish 按鈕結束精靈視窗即可。

![/images/posts/PostSharpINotifyPropertyChangedImplement/4.png](/images/posts/PostSharpINotifyPropertyChangedImplement/4.png)
...
![/images/posts/PostSharpINotifyPropertyChangedImplement/5.png](/images/posts/PostSharpINotifyPropertyChangedImplement/5.png)

到這邊已經用 PostSharp 幫我們自動實作完 INotifyPropertyChanged 了，若有需要可將滑鼠移至類別上再次進行確認，沒意外的話就會看到確實已經套用完成(若沒有這畫面可能是因為資料還未更新完成，可嘗試重建專案看看)。

![/images/posts/PostSharpINotifyPropertyChangedImplement/6.png](/images/posts/PostSharpINotifyPropertyChangedImplement/6.png)
...
![/images/posts/PostSharpINotifyPropertyChangedImplement/7.png](/images/posts/PostSharpINotifyPropertyChangedImplement/7.png)
