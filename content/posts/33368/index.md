...
public static void RaiseEvent(this object obj, EventHandler handler, Func func)
{
if (handler == null)
return;
handler(obj, func());
...
public static void RaiseEvent(this object obj, EventHandler handler,Func func) where TEventArgs : EventArgs
{
if (handler == null)
return;
handler(obj, func());
...
{
_
this.RaiseEvent(NameChanged, () => new NameEventArgs() { });
}
}
}
