...
description: "SonarQube 運行 Pre-processing 時，可能會拋出 Failed to create an empty directory 這樣的錯誤訊息。 這錯誤是因為 SonarQube 運行時會需要建立一個 .sonarqube 的目錄，該目錄如果因位檔案佔住無法刪除就會發生這樣的錯誤。"
tags: [SonarQube]
---
