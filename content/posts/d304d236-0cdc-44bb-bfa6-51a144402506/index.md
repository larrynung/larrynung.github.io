...
![image_thumb_7.png](/images/posts/d304d236-0cdc-44bb-bfa6-51a144402506/image_thumb_7.png)
...
![image_thumb_3.png](/images/posts/d304d236-0cdc-44bb-bfa6-51a144402506/image_thumb_3.png)

這時開啟檔案總管，將當前目錄切至"%LOCALAPPDATA%\CrashDumps"(預設的dump存放在這個位置，可參閱上方MSDN的圖片)，可以看到Windows Error Reporting幫我們抓的dump就放在裡面。

![image_thumb.png](/images/posts/d304d236-0cdc-44bb-bfa6-51a144402506/image_thumb.png)

滑鼠連點候用Visual Studio開啟，會看到像下面這樣的Minidump File Summary，這時點擊右側的Debug with Mixed連結。

![image_thumb_6.png](/images/posts/d304d236-0cdc-44bb-bfa6-51a144402506/image_thumb_6.png)

Visual Studio若找的到對應的程式與PDB的話，就會將其帶出方便開發人員找到問題的所在。

![image_thumb_5.png](/images/posts/d304d236-0cdc-44bb-bfa6-51a144402506/image_thumb_5.png)
...
![image_thumb_8.png](/images/posts/d304d236-0cdc-44bb-bfa6-51a144402506/image_thumb_8.png)

然後新增一個可擴充字串值。

![image_thumb_1.png](/images/posts/d304d236-0cdc-44bb-bfa6-51a144402506/image_thumb_1.png)

取名為DumpFolder，將其值設定為%localappdata%，讓dump出來的檔字直接放在Local App Data下。(注意到在win7以後的電腦，dump存放的位置要特別留意，不然可能會被UAC給擋住)

![image_thumb_2.png](/images/posts/d304d236-0cdc-44bb-bfa6-51a144402506/image_thumb_2.png)

再次運行程式，程式掛掉後我們應該要可以在Local App Data下看到dump出來的檔案。

![image_thumb_4.png](/images/posts/d304d236-0cdc-44bb-bfa6-51a144402506/image_thumb_4.png)
