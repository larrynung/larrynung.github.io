---
title: "[VB.NET]Load and Run an Assembly from a Resource File Using Reflection"
slug: "vbnet-load-and-run-an-assembly-from-a-resource-file-using-reflection"
aliases: ["/posts/15588/"]
date: "2010-06-02 11:39:32"
description: "要載入並運行資源檔中的組件，最簡單的方法就是開個新的專案，把要真正要執行的組件加入資源檔中。 再用Assembly.Load載入組件後，呼叫EntryPoint.Invoke去執行組件即可。 同樣的概念，其實放在資源檔中的組件可以先經過壓縮處理，再放入資源檔中。"
tags: [VB.NET]
---

要載入並運行資源檔中的組件，最簡單的方法就是開個新的專案，把要真正要執行的組件加入資源檔中。

![image_thumb.png](/images/posts/15588/image_thumb.png)
...
![image_thumb_1.png](/images/posts/15588/image_thumb_1.png)
