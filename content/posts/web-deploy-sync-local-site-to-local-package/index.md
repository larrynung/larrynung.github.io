...
description: "要用 Web Deploy 將本地站台打包成 Web Deploy Package，可以指定 Web Deploy 使用 sync 操作，source 使用 appHostConfig provider，帶入要打包的站台名稱，dest 使用 package provider，"
tags: [Web Deploy]
---
...
msdeploy -verb:sync -source:appHostConfig="" -dest: package=
