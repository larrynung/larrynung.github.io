---
title: "[C#][VB.NET]XML-Serializing Private Fields"
slug: "csharp-vbnet-xml-serializing-private-fields"
aliases: ["/posts/csharpvb.netxml序列化私有欄位/"]
date: "2008-11-29 10:17:07"
description: "假設今天有個Person的類別如下。除了名字、年齡、性別外，內含_friends清單用以提供IsFriend與AddFriend函式所須用到的朋友清單資料。 VB.NET C# 在.NET程式裡，若將該類別直接做XML序列化，"
tags: [VB.NET,CSharp]
---
...
![image_thumb.png](/images/posts/6127/image_thumb.png)
