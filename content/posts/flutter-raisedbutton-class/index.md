...
| onHighlightChanged | ValueChanged | Called by the underlying InkWell widget's InkWell.onHighlightChanged callback. |
...
| debugDescribeChildren() | List | ist of DiagnosticsNode objects describing this node's children. |
