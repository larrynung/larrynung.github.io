---
title: "[Software]Sync Google and Notes Calendars with GooCalSync"
slug: "software-sync-google-and-notes-calendars-with-goocalsync"
aliases: ["/posts/17091/"]
...
![image_thumb_1.png](/images/posts/17091/image_thumb_1.png)

接著透過Ctrl+N快速鍵，或是透過點選[檔案]→[資料庫]→[新增]開啟新資料庫對話框，設定標題與檔案位置後按下確定。

![image_thumb_2.png](/images/posts/17091/image_thumb_2.png)

完成後工作區中應該會看到GoogleCalSync的圖示。

![image_thumb_3.png](/images/posts/17091/image_thumb_3.png)

點選開啟設定細部設定，主要要設定的有GOOGLE帳密、Notes Domino Server、Mail DB檔案、同步的類型、Proxy...等。

![2010-07-29_171757_thumb.png](/images/posts/17091/2010-07-29_171757_thumb.png)

這邊比較有問題的設定應該是Notes Domino Server與Mail DB檔案，可在Notes郵件圖示上方按下滑鼠右鍵，在彈出的快顯選單中點選[資料庫]→[屬性]，查看資料庫屬性對話框中的伺服器與檔名設定。

![2010-07-29_173103_thumb.png](/images/posts/17091/2010-07-29_173103_thumb.png)

![image_thumb_4.png](/images/posts/17091/image_thumb_4.png)

到此，同步Google與Notes日曆的設定已經完成，可直接用滑鼠點擊開啟剛下載的壓縮檔中的GooCalSync.bat檔，就可以進行同步的動作。

![2010-07-30_153120_thumb.png](/images/posts/17091/2010-07-30_153120_thumb.png)

除此之外，您也可以在Notes的工具列上建立一個自訂按鈕方便來做同步的動作，只要在Notes工具列上按下滑鼠右鍵，在彈出的快顯選單中點選[工具列細項設定...]。

![2010-07-29_171843_thumb.png](/images/posts/17091/2010-07-29_171843_thumb.png)

在工具列細項設定對話框中的工具列頁籤，選取自訂按鈕要襬放的工具列。

![image_thumb.png](/images/posts/17091/image_thumb.png)

接著切到自訂頁籤，按下[新增]→[按鈕]。

![image_thumb_6.png](/images/posts/17091/image_thumb_6.png)

再填入自訂按鈕的內文、說明文字、與要運行的公式即可。公式請依下面格式輸入：

@Command([Execute];"[GooCalSync.bat完整路徑]")

![2010-07-29_172252_thumb.png](/images/posts/17091/2010-07-29_172252_thumb.png)

完成後在工具列上就可看到自己加入的同步按鈕。

## Link

* [GooCalSync](http://www.openntf.org/projects/pmt.nsf/db3ab1728ca15962862570a70058a1d8/a243806ae6ae42ad8625758b006e7bc3!OpenDocument)
* [與谷歌同步吧-谷歌日曆同步程式(Google Calendar Sync)](http://www.dotblogs.com.tw/huchungling/archive/2009/06/15/8835.aspx)
