...
又從保哥Blog那邊挖到好東西^^，原來有工具可以幫助我們建置專案卻不用開啟Visual Studio。而且只需安裝MSBuild Shell Extension，在專案檔上按滑鼠右鍵就可以辦到。使用上就像它的網頁上秀的圖一樣簡單。
...
## Link
The Will Will Web-介紹好用工具：MSBuild Shell ExtensionCodePlex-MSBuildShellExtension