...
description: "要列出 Kafka 的 Topic，可以調用 kafka-topics.sh，帶入參數 --list 指示要列出 topic、--zookeeper 參數指定 ZooKeeper 位置。 bin/kafka-topics.sh --list --zookeeper [ZooKeeper] Link"
tags: [Kafka]
---
