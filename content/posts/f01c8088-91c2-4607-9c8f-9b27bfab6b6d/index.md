...
const string DETECT_API_URI_PATTERN = "http://api.microsofttranslator.com/V2/Http.svc/Detect?app
...
select new { lang, new string[] { lang })[0], Value = lang }).ToList();
