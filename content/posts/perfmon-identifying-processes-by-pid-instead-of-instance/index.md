...
![1.png](/images/posts/PerfmonWithPID/1.png)
...
![2.png](/images/posts/PerfmonWithPID/2.png)

![3.png](/images/posts/PerfmonWithPID/3.png)

![4.png](/images/posts/PerfmonWithPID/4.png)

重啟效能監視器，可看到本來看到的後綴會變成 Process ID，使用效能監視器時會比較好區別監看的 Process。

![5.png](/images/posts/PerfmonWithPID/5.png)
