...
![1.jpg](/images/posts/DropSequenceWithOracleSqlDeveloper/1.jpg)

在彈出的 Drop 對話框中會顯示所要移除的 Sequence，確定無誤後按下 `Apply` 按鈕套用。

![2.jpg](/images/posts/DropSequenceWithOracleSqlDeveloper/2.jpg)

完成後當彈出 Confirmation 對話框告知。

![3.jpg](/images/posts/DropSequenceWithOracleSqlDeveloper/3.jpg)