...
tags: [CSharp]
description: "Aliaser 是 Visual Studio 的套件，能針對 C# 型別或是別名做轉換。 該套件可透過 Extension Manager 搜尋安裝。 套件安裝完點選 Tools 主選單就會看到 Aliaser 選單，裡面有 To alias 與 To instance 選單選項。"
---
